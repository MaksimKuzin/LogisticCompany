...
namespace LogisticCompany.Migrations
{
    ...
    [Migration("20241031083151_atrFix")]
    partial class atrFix
    {
            ...
            modelBuilder.Entity("LogisticCompany.Models.Order", b =>
                {
                    ...
                    b.HasOne("LogisticCompany.Models.Tranport", "Tranport")
                        .WithMany("Orders")
                        .HasForeignKey("TranportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
